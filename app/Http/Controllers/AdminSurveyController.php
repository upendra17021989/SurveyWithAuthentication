...
class AdminSurveyController extends Controller
{
    ...
    public function index()
    {
        $adminSurveyDetails = DB::table('company_survey')->join('company', 
            ...
            'forms.form_id', '=', 'company_survey.form_id')->select('company_survey.survey_id as survey_id', 'company.company_name as company_name', 'forms.form_name as form_name','company_survey.survey_name', 'company_survey.start_dt', 'company_survey.end_dt')->get();
